...
public class GraphTransform implements IGraph {
	...
	public GraphTransform(INode root) {
	...
	public GraphTransform(String id, INode root) throws Exception {
		this.mNodes.add(root);
		this.mRoot = root;
		root.setGraph(this);
	...
	public IGraph transform(IGraph g){
		INode root = new NodeTransform();	//gets all the information from edges.
		IGraph g2 = new GraphTransform(root);
		//TODO- apply dfs for conversion
		return g2;				//vs return this;
	}
}
